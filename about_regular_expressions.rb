...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When would * fail to match?
      # when the first character in the regexp doesn't exist
  end
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    # Looks like the word characters because you often name things in ruby with snake case, which inclues undrscores
  end
